<%@ Page Title="" Language="C#" MasterPageFile="~/User/CustomerMaster.Master" AutoEventWireup="true" CodeBehind="SignUp.aspx.cs" Inherits="MM_Travelling.User.SignUp" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        ...
        <ContentTemplate >
            <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
             <div style="margin-top:10px!important; opacity:0.95; background-color:pink " class="form-group shadow pt-lg-3  w-75 h-75 mb-lg-5  pr-lg-3 pl-lg-3 ml-auto mr-auto ">
        ...
        <div class=" ml-auto w-100  w-75 mr-auto">
            ...
            <div class="w-100 d-flex flex-row justify-content-around ">
                ...
                <div class="form-group col-5 w-100 ">
                    ...
                    <span style="color: red;">*</span>
                    <asp:TextBox runat="server"   ID="txtEmail" TextMode="Email" CssClass="form-control w-100 " AutoCompleteType="None"  TabIndex="1" />
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" 
                                ControlToValidate="txtEmail" ErrorMessage="*" ForeColor="Red" 
                                SetFocusOnError="True"></asp:RequiredFieldValidator>
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" 
                            ControlToValidate="txtEmail" ErrorMessage="Erroring !!" ForeColor="Red" 
                    ...
                    <div class="form-group w-100 col-5 w-100  ">
                        <asp:Label ID="Label4" Text="Phone No" runat="server" />
                        <span style="color: red;">*</span>
            ...
            <div class="w-100 d-flex flex-row justify-content-around">
                ...
                <div class="form-group w-100 col-5 w-100  ">
                    <asp:Label ID="Label6" Text="Address " runat="server" />
                    <span style="color: red;">*</span>
            ...
            <div class="w-100 d-flex flex-row justify-content-around">
                ...
                <div class="form-group w-100 col-5 w-100  ">
                    <asp:Label ID="Label7" Text="Confirm Password" runat="server" />
                    <span style="color: red;">*</span> 
         ...
         <div class="form-group w-50 m-auto   p-2 d-flex flex-column ">
                ...
                <asp:LinkButton ID="LinkButton1" PostBackUrl="~/SignIn.aspx" CssClass="btn-link mt-2 ml-auto mr-auto" Text="Already account Login!" runat="server" TabIndex="10" />
         </div>
    </div>
        </ContentTemplate>
    </asp:UpdatePanel>
